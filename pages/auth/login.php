<form method='post' action='?page=loginForm' class='flex items-center bg-[#618779] py-5 px-2 my-0 mx-0 justify-center w-1/3  border-4 border-[#9DA668] border-solid rounded-lg min-w-[50%] '>
    <div class='w-2/3'>
        <div class="mb-6">
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-900">Your email</label>
            <input name='name' type="text" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example@gmail.com" required="" <?php
        ...
        <div class="flex items-start mb-6 text-black">
            ...
            <label for="remember" class="ml-2 text-sm font-medium  dark:text-gray-900 ">Remember me</label>
        </div>
